...
class Token {
	...
	public Token next;  // Peek tokens are kept in linked list
}
...
public class Scanner {
	...
	static {
		...
		for (int i = 179; i <= 180; ++i) start.set(i, 1);
		for (int i = 186; i <= 186; ++i) start.set(i, 1);
		for (int i = 191; i <= 191; ++i) start.set(i, 1);
		for (int i = 224; i <= 249; ++i) start.set(i, 1);
		for (int i = 252; i <= 252; ++i) start.set(i, 1);
		for (int i = 254; i <= 255; ++i) start.set(i, 1);
		...
		loop: for (;;) {
			switch (state) {
				...
				case 1:
					...
					if (ch >= '0' && ch <= '9' || ch == '_' || ch >= 179 && ch <= 180 || ch == 186 || ch == 191 || ch >= 224 && ch <= 249 || ch == 252 || ch >= 254 && ch <= 255) {AddCh(); state = 1; break;}
				...
				case 3:
					if (ch == 202) {AddCh(); state = 4; break;}
					else {state = 0; break;}
				case 4:
					if (ch == 217) {AddCh(); state = 5; break;}
					else {state = 0; break;}
				case 5:
					if (ch == 206) {AddCh(); state = 6; break;}
					else {state = 0; break;}
				case 6:
					{t.kind = 3; break loop;}
				case 7:
					if (ch == 206) {AddCh(); state = 8; break;}
					else {state = 0; break;}
				case 8:
					if (ch == 196) {AddCh(); state = 9; break;}
					else {state = 0; break;}
				case 9:
					if (ch == 178) {AddCh(); state = 10; break;}
					else {state = 0; break;}
				case 10:
					{t.kind = 4; break loop;}
				case 11:
					if (ch == 205) {AddCh(); state = 12; break;}
					else {state = 0; break;}
				case 12:
					if (ch == 192) {AddCh(); state = 13; break;}
					else {state = 0; break;}
				case 13:
					if (ch == 202) {AddCh(); state = 14; break;}
					else {state = 0; break;}
				case 14:
					if (ch == 216) {AddCh(); state = 15; break;}
					else {state = 0; break;}
				case 15:
					if (ch == 197) {AddCh(); state = 16; break;}
					else {state = 0; break;}
				case 16:
					{t.kind = 5; break loop;}
				case 17:
					if (ch == 'r') {AddCh(); state = 18; break;}
					else {state = 0; break;}
				case 18:
					if (ch == 'o') {AddCh(); state = 19; break;}
					else {state = 0; break;}
				case 19:
					if (ch == 'g') {AddCh(); state = 20; break;}
					else {state = 0; break;}
				case 20:
					if (ch == 'r') {AddCh(); state = 21; break;}
					else {state = 0; break;}
				case 21:
					if (ch == 'a') {AddCh(); state = 22; break;}
					else {state = 0; break;}
				case 22:
					if (ch == 'm') {AddCh(); state = 23; break;}
					else {state = 0; break;}
				case 23:
					{t.kind = 6; break loop;}
				case 24:
